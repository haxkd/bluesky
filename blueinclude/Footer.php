				...
				<div class="row">
					<div class="col-lg-3 footer_col">
						<div class="footer_about">
							<div class="footer_about_text">Of course, in a refrigerator. Mauris really fast as a garment policies. In time to come to the porch for example, in its non-pregnant. Default curab go running but with arrows.
                                                        </div>
						</div>
					</div>
					<div class="col-lg-3 footer_col">
				...
				<div class="row">
					<div class="col">
						<div class="footer_bar_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="footer_phone ml-auto"><span>call us: </span>070 074 205 72</div>
						</div>
					</div>
				</div>
			</div>
